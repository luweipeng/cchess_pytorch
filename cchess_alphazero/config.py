...
class ResourceConfig:
    def __init__(self):
        ...
        self.model_best_path = os.path.join(self.model_dir, "model_best.pth")
        ...
        self.next_generation_path = os.path.join(self.next_generation_model_dir, "next_generation.pth")
        ...
        self.pk_log_path = os.path.join(self.log_dir, "pk.log")
